...
***** COMMENT Install dependencies of ADS server
...
#+end_src
***** COMMENT Template to modify ADS configuration files
...
***** COMMENT Add knowhost keys of ads server to ansible's vlead
