...
** Enable hooks between ADS and Config/ansible server
   - NOTE :: To Enter into containers use the following
   ...
   3. Paste the copied ( step 1) key in 
      ...
      - NOTE 2 :: Make sure that the file
		  ...
		  #+BEGIN_SRC 
		  chmod 644 /home/vlead/.ssh/authorized_keys
		  #+END_SRC
** Steps to deploy lab
   1. Go to ADS server (Container ID 1009)
   ...
   3. Run app.py 
      #+BEGIN_SRC 
       cd ~/ovpl/src/ads-web-app/
       export http_proxy="http://proxy.iiit.ac.in:8080"
       export https_proxy="http://proxy.iiit.ac.in:8080"      
       python app.py &
      #+END_SRC
   4. Use http://ads.<cluster-name>.vlabs.ac.in:8080 url and
      deploy the lab.
