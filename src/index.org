...
* Installation manual
  - [[./imp/installation-steps.org][Installation manual]]
* Bootstrapping steps
  - [[./imp/bootstrapping.org][Bootstrapping steps]]
...
* Important Repositories
  ...
  - [[https://github.com/vlead/setup-ovpl-centos][setup-ovpl-centos]]
  - [[https://gitlab.com/vlead-systems/systems-model][systems-model]]
...
* Main Branches in cluster-automation repository
